...
function setupAdmin(){
  qs('#unlockAdmin').addEventListener('click',()=>{
    if(qs('#adminPin').value === 'JS2026') {qs('#adminGate').classList.add('hidden');qs('#adminDashboard').classList.remove('hidden');qs('#pinFeedback').textContent=''; showAdminPanel('materials');}
    else qs('#pinFeedback').textContent='Incorrect PIN.';
  });
